...
namespace Dummiesman 
{
    public static class OBJLoaderHelper  
    {
        ...
        public static Material CreateNullMaterial()
        {
            ...
            //return new Material(Shader.Find("Mobile/Diffuse"));

#if UNITY_ANDROID
    Debug.Log("Android platform detected, using Mobile/Diffuse shader.");
    return new Material(Shader.Find("Mobile/Diffuse"));
#elif UNITY_STANDALONE_OSX
            Debug.Log("macOS platform detected, using Standard (Specular setup) shader.");
            return new Material(Shader.Find("Standard (Specular setup)"));
#elif UNITY_STANDALONE_WIN
    Debug.Log("Windows platform detected, using Standard shader.");
    return new Material(Shader.Find("Standard"));
#else
    Debug.LogWarning("Platform not explicitly handled, using Standard shader as fallback.");
    return new Material(Shader.Find("Standard"));
#endif
        }
